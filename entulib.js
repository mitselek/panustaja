...
var EntuLib = function EntuLib(entu_user_id, entu_user_key, entu_url) {
    ...
    return {
        getEntity: function (entity_id, callback) {
            ...
            __submit_it(path, 'GET', data, callback)
        },
...
const ENTU_USER_ID = 4
const ENTU_USER_KEY = process.env['ENTU_SAAL_KEY']
const ENTU_URL = 'saal.entu.ee'

var EntuLib = new EntuLib(ENTU_USER_ID, ENTU_USER_KEY, ENTU_URL)
EntuLib.getEntity(4, print_result)
